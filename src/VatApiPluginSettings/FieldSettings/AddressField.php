...
class AddressField implements InterfaceFieldSettings
{
    ...
    {
        add_settings_field(
            'vatapi-address-id-field',
            __('ID of Address input field:', 'vatapiwc'),
    ...
    public function renderFieldsHTML(): void
    {
        ...
        if (isset($options[$this->field_name])) {
            ...
            echo sprintf('<input id="%1$s" name="%2$s[%1$s]" type="text" value="#billing_address_1">', $this->field_name, $this->options_name);
        }
    }
}