...
class VatIdField implements InterfaceFieldSettings
{
    ...
    {
        add_settings_field(
            'vatapi-vatid-id-field',
            __('ID of Vat ID input field:', 'vatapiwc'),
    ...
    public function renderFieldsHTML(): void
    {
        ...
        if (isset($options[$this->field_name])) {
            ...
            echo sprintf('<input id="%1$s" name="%2$s[%1$s]" type="text" value="#vat_number">', $this->field_name, $this->options_name);
        }
    }
}