...
class CompanyNameField implements InterfaceFieldSettings
{
    ...
    {
        add_settings_field(
            'vatapi-company-id-field',
            __('ID of company name input field:', 'vatapiwc'),
    ...
    public function renderFieldsHTML(): void
    {
        ...
        if (isset($options[$this->field_name])) {
            ...
            echo sprintf('<input id="%1$s" name="%2$s[%1$s]" type="text" value="#billing_company">', $this->field_name, $this->options_name);
        }
    }
}